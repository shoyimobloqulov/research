        ...
        <div class="card-body text-center">
            <div class="row h-100 justify-content-center align-items-center">
                <div class="col-auto">
                    ...
                    <h1 class="text-danger">Bu mavzuda qatnashish imkoniyati sizda mavjud emas!</h1>
                    <p class="text-secondary mb-3">Iltimos, keyinroq qayta urinib ko'ring yoki bosh sahifaga
                        qayting.</p>
                    <a href="{{ route('test.submit',$id) }}" class="btn btn-link">Testga o'tish <i
